...
lable_0 = Label(root,text="Weather Forecast",width = 20,bg='white',font=("bold",20),fg='brown')
...
lable_temp = Label(root,text="...",width = 7,bg='white',font=("bold",10),fg='blue')
lable_temp.place(x=192,y=220)

lable_pres = Label(root,text="...",width = 7,bg='white',font=("bold",10),fg='blue')
lable_pres.place(x=192,y=240)

lable_desc = Label(root,text="...",width = 7,bg='white',font=("bold",10),fg='blue')
...
def getTemp():
    ...
    api_key = "1496121425430cf274a864e0e1e79657"
...
# module response get
    ...
    if["cod"] !='404':
        y = x["main"]
        current_temprature_kelvin = y["temp"]
        ...
        lable_temp.configure(text=current_temprature_kelvin)
